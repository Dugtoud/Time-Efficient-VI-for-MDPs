...
int main (void){
		...
		//thread th21(create_data_tables_number_of_actions_VIH_implementations,file_prefix_number_of_actions_VIH_impl, S, A_max, epsilon, gamma, upper_reward, non_zero_transition);
